          ...
          <>
            ...
            <div className="mb-6 grid grid-cols-3 gap-3">
              ...
              >
                ...
                <div className="text-2xl font-bold text-gray-900">{myJobs?.stats.activeJobs ?? 0}</div>
              ...
              >
                ...
                <div className="text-2xl font-bold text-gray-900">{myJobs?.stats.completedJobs ?? 0}</div>
              ...
              <div className="rounded-2xl border border-gray-100 bg-white p-4 text-center shadow-sm">
                ...
                <div className="mt-0.5 text-xs text-gray-500">{jobsT("rating")}</div>
              </div>
            </div>
            ...
            <div className="mb-6 rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
              <div className="mb-4 flex items-center justify-between">
                ...
                <Link
                  href="/worker/profile"
                  className="inline-flex items-center gap-1 rounded-xl bg-blue-50 px-3 py-1.5 text-sm font-medium text-blue-600 transition hover:bg-blue-100"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="14"
              ...
              <div className="mb-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                ...
                <div className="space-y-3">
                  {myJobs.active.slice(0, 2).map((job) => (
                    <Link
                      ...
                      className="block rounded-xl border border-gray-100 bg-gray-50 p-4 transition hover:border-blue-200 hover:bg-blue-50"
                    >
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          <div className="font-semibold text-gray-900">{job.title}</div>
                          <div className="text-xs text-gray-500">{job.employerName}</div>
                        </div>
                        <Badge tone="warning">
