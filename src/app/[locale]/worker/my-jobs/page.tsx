      ...
      >
        ...
        {payment && (
          <div className="mb-3 flex items-center justify-between rounded-lg bg-gray-50 p-3">
            <span className="text-xs font-medium text-gray-500">{t("payment")}</span>
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-2xl px-4 py-6 pb-24 sm:pb-8">
        ...
        {/* Tabs */}
        <div role="group" aria-label={t("title")} className="mb-6 grid grid-cols-2 gap-2 rounded-2xl bg-gray-100 p-1.5">
          <button
