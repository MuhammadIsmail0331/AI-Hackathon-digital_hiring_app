    ...
    <>
      ...
      <main className="mx-auto max-w-2xl px-4 py-6 pb-24 sm:pb-8">
        ...
        <div className="mb-6 grid grid-cols-3 gap-3">
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-4 text-center shadow-sm">
            <div className="mx-auto mb-1 flex h-8 w-8 items-center justify-center rounded-lg bg-gray-100 text-gray-600">
        ...
        <Link
          ...
          className="mb-6 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 text-base font-semibold text-white shadow-lg shadow-blue-200 transition hover:shadow-xl hover:shadow-blue-300"
        >
        ...
        {recentJobs.length > 0 ? (
          <div>
            <div className="mb-3 flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-900">{t("recentJobs")}</h2>
              <Link href="/employer/jobs" className="text-sm font-medium text-blue-600 hover:text-blue-700">
                {t("allJobs")} →
              </Link>
            </div>
              ...
              {recentJobs.map((job) => {
                ...
                return (
                  <Link
                    ...
                    className="block rounded-2xl border border-gray-100 bg-white p-4 shadow-sm transition hover:border-blue-200 hover:shadow-md"
                  >
          ...
          <div className="rounded-2xl border-2 border-dashed border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 p-8 text-center">
            ...
            <h2 className="mb-2 text-lg font-semibold text-gray-900">{jobsT("noJobs")}</h2>
            <p className="mb-6 text-sm text-gray-500">{jobsT("noJobsDesc")}</p>
            <Link
              href="/employer/jobs/new"
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-3 text-base font-semibold text-white shadow-lg shadow-blue-200 transition hover:shadow-xl hover:shadow-blue-300"
            >
