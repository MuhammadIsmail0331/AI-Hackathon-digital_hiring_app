      ...
      <main className="mx-auto max-w-2xl px-4 py-6 pb-24 sm:pb-8">
        ...
        <div className="mb-6 grid grid-cols-3 gap-3">
          <div className="rounded-2xl border border-line bg-surface p-4 text-center shadow-sm">
            ...
            <div className="text-2xl font-bold text-ink">{profile.stats.totalJobs}</div>
          ...
          <div className="rounded-2xl border border-line bg-surface p-4 text-center shadow-sm">
            ...
            <div className="text-2xl font-bold text-ink">{profile.stats.activeJobs}</div>
          ...
          <div className="rounded-2xl border border-line bg-surface p-4 text-center shadow-sm">
            ...
            <div className="text-2xl font-bold text-ink">{profile.stats.completedJobs}</div>
        ...
        <section className="rounded-2xl border border-line bg-surface p-5 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Name */}
            <div>
              <label htmlFor="employer-name" className="mb-1.5 block text-sm font-medium text-ink">
                {t("name")}
              </label>
              <input
                id="employer-name"
            ...
            {/* Phone */}
            <div>
              <label htmlFor="employer-phone" className="mb-1.5 block text-sm font-medium text-ink">
                {t("phone")}
              </label>
              <input
                id="employer-phone"
            ...
            {/* Email (read-only) */}
            <div>
              <label htmlFor="employer-email" className="mb-1.5 block text-sm font-medium text-ink">
                {t("email")}
              </label>
              <input
                id="employer-email"
