    ...
    <>
      ...
      <main className="mx-auto max-w-2xl px-4 py-6 pb-24 sm:pb-8">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-2xl font-bold text-ink">{t("myJobs")}</h1>
          <Link
            href="/employer/jobs/new"
            className="inline-flex items-center gap-1.5 rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700"
          >
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border-2 border-dashed border-primary/40 bg-primarysoft p-8 text-center">
            ...
            <h2 className="mb-2 text-lg font-semibold text-ink">{t("noJobs")}</h2>
            <p className="mb-6 text-sm text-muted">{t("noJobsDesc")}</p>
            <Link
              href="/employer/jobs/new"
              className="inline-flex items-center gap-2 rounded-xl bg-primary px-6 py-3 text-base font-semibold text-white shadow-sm transition hover:bg-blue-700"
            >
              {t("createFirstJob")}
            </Link>
          </div>
            ...
            {jobs.map((job) => {
              ...
              return (
                <Link
                  ...
                  className="block rounded-2xl border border-line bg-surface p-4 shadow-sm transition hover:border-primary/40 hover:shadow-md"
                >
